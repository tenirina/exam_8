...
class Review(models.Model):
    author = models.ForeignKey(to=get_user_model(), verbose_name='Author', related_name='review', null=False, blank=False, on_delete=models.CASCADE)
    product = models.ForeignKey(to=Product, verbose_name='webapp.Product', related_name='review', null=False, blank=False, on_delete=models.CASCADE)
